...
enum opt_code
{
  ...
  OPT_ftree_partial_pre = 893,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 894,                   /* -ftree-phiprop */
  OPT_ftree_pre = 895,                       /* -ftree-pre */
  OPT_ftree_pta = 896,                       /* -ftree-pta */
  OPT_ftree_reassoc = 897,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 898, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 899,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 900,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 901,             /* -ftree-slp-vectorize */
  OPT_ftree_sra = 902,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 903, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 904, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 905,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 906,                /* -ftree-tail-merge */
